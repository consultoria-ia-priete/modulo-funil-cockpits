...
const WHATSAPP_GROUP_URL = "https://SEU-DOMINIO.com/grupo";
const FUNNEL_SOURCE = "quiz-negocio-ia";
const PRODUCT_LABEL = "negócio.ia";
...
const readLeadIdentity = () => {
  ...
  // Cookie cross-domain (.SEU-DOMINIO.com) é o caminho principal — funciona pra leads
  // que vieram da LP NegocioIA mas caíram no /obrigado deste subdomínio.
          ...
          <div className="bg-card border-2 border-primary/50 rounded-2xl p-6 md:p-8 text-left animate-card-glow">
            ...
            <p className="text-muted-foreground mb-6 leading-relaxed">
              ...
              <span className="text-foreground font-bold">
                Como Criar uma ConsultorIA com IA para faturar +R$30K/Mês
              </span>{" "}
              e conheça a{" "}
              <span className="text-foreground font-bold">
            ...
            <div className="flex items-start gap-3 p-4 mb-6 rounded-lg border border-red-500/30 bg-red-950/30">
              ...
              <p className="text-sm md:text-base text-red-200">
                Restam <span className="font-bold underline decoration-red-400">poucas vagas</span>{" "}
                na sala VIP. Corra!
              </p>
            </div>
